...
Main Object: Car Interior
    ...
    Sub Object: Instrument Cluster
        ...
        Name 3 actions that the [Sub Object] can do:
            1) display miles driven
            2) display gas remaining
            3) display speed
    ...
    Sub Object: Infotainment System
        ...
        Name 3 actions that the [Sub Object] can do:
            1) adjust the volume
            2) adjust the cannel of the radio
            3) adjust the source of the media

    Sub Object: Seat
        Name 3 nouns you'll find on the [Sub Object]
            1) heater buttons
            2) recliner buttons
            3) headrest adjusters
        Name 2 actions that the [Sub Object] can do:
            1) heat the seats
            2) recline the seats
*/
